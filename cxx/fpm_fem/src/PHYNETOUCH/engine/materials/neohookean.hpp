...
#ifndef PHYNETOUCH_MATERIALS_NEOHOOKEAN_HPP_
#define PHYNETOUCH_MATERIALS_NEOHOOKEAN_HPP_
 ...
 */
class Neohookean : public Constitutive
{
...
#endif //PHYNETOUCH_MATERIALS_NEOHOOKEAN_HPP_