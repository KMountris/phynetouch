...
/**
   \file rigid.hpp
   \brief Rigid class header file.
   \author Konstantinos A. Mountris
   \date 26/10/2021
*/

#ifndef PHYNETOUCH_MATERIALS_RIGID_HPP_
#define PHYNETOUCH_MATERIALS_RIGID_HPP_
 ...
 * \class Rigid
 * \author Konstantinos A. Mountris
 * \brief Class implemmenting a neohookean hyperelastic material.
 */
class Rigid : public Constitutive
{
...
#endif //PHYNETOUCH_MATERIALS_RIGID_HPP_